"""
    File Name: contral_joints.py
    Author: XiaoHai
    Date: 2025-05-03
    Version: 1.0
    Description:加载dummy的mjcf描述文件,控制机械臂在关节空间运动
    Usage:通过以下指令运行代码
        $ conda activate mujoco_py
        $ python contral_joints.py
"""
import mujoco
import numpy as np
import glfw
...
def main():
    ...
    window = glfw.create_window(1200, 900, 'Dummy Arm Control', None, None)
    if not window:
        glfw.terminate()
        return
